...
let Player = function () {
  ...
  this.draw = function () {
    try {
      if (this.dir === 'right') this.cx = 0
      else if (this.dir === 'left') this.cx = 576
      else if (this.dir === 'right_land') this.cy = 0
      else if (this.dir === 'left_land') this.cy = 0

      ctx.drawImage(character, this.cx, this.cy, this.cwidth, this.cheight, this.x, this.y, this.width, this.height)
    } catch (e) {}
  }
...
let Platform_broken_substitute = function () {
  this.height = 30
  this.width = 70
...
let platform_broken_substitute = new Platform_broken_substitute()
...
function init () {
  ...
  function gameOver () {
    ...
    if (player.y > height / 2 && flag === 0) {
      ...
      let facebook = document.getElementById('fbBtn')
...
function showGoMenu () {
  ...
  let scoreText = document.getElementById('go_score')
